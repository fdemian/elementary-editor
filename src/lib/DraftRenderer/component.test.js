...
describe("<DraftRenderer />", () => {
  ...
  it("Render inline elements.", () => {
   ...
   const componentsToRender = [
    ...
    {
      htmlTag: 'h2',
      draftState: {"blocks":[{"key":"edmlk","text":"Header Text","type":"header-two","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}}],"entityMap":{}}
    },
    {
      htmlTag: 'pre',
      draftState: {"blocks":[{"key":"edmlk","text":"function()","type":"code-block","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}}],"entityMap":{}}
    }
   ];
  ...
  it("Render unordered list.", () => {
    ...
    const ulState = {"blocks":[{"key":"edmlk","text":"one","type":"unordered-list-item","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}},{"key":"d7pec","text":"two","type":"unordered-list-item","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}},{"key":"ocg8","text":"three","type":"unordered-list-item","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}}],"entityMap":{}};
  ...
  it("Render ordered list.", () => {
    ...
    const olState = {"blocks":[{"key":"edmlk","text":"one","type":"ordered-list-item","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}},{"key":"cgpf","text":"two","type":"ordered-list-item","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}},{"key":"2bkc3","text":"three","type":"ordered-list-item","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}}],"entityMap":{}};
  ...
  it("Render <img> element.", () => {
    ...
    const imgState = {"blocks":[{"key":"edmlk","text":"","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}},{"key":"epdm5","text":"Image","type":"atomic","depth":0,"inlineStyleRanges":[],"entityRanges":[{"offset":0,"length":5,"key":0}],"data":{}},{"key":"4kijn","text":"","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}}],"entityMap":{"0":{"type":"Image","mutability":"IMMUTABLE","data":{"src":"https://www.url.com/image.jpg"}}}};
  ...
  it("Render <Link> element.", () => {
    ...
    const linkState = {"blocks":[{"key":"c7tkv","text":"Link","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[{"offset":0,"length":4,"key":0}],"data":{}}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":linkUrl}}}};
  ...
  it("Render <Spoiler> element.", () => {
    ...
    const spoilerState = {"blocks":[{"key":"bgdnj","text":spoilerText,"type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[{"offset":0,"length":12,"key":0}],"data":{}}],"entityMap":{"0":{"type":"SPOILER","mutability":"IMMUTABLE","data":{"text":spoilerText}}}};
  ...
  it("Render <Latex> element.", () => {
    //const spoilerText = "spoiled text";
    const latexState = {"blocks":[{"key":"5a36h","text":"","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}},{"key":"e6b3g","text":" ","type":"atomic","depth":0,"inlineStyleRanges":[],"entityRanges":[{"offset":0,"length":1,"key":0}],"data":{}},{"key":"75dr8","text":"","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}}],"entityMap":{"0":{"type":"LATEX","mutability":"Immutable","data":{"content":"f(x) = ... "}}}};
  ...
  it("Render <Video> element.", () => {
    ...
    const videoState = {"blocks":[{"key":"1e7ve","text":"","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}},{"key":"9t06p","text":"Video","type":"atomic","depth":0,"inlineStyleRanges":[],"entityRanges":[{"offset":0,"length":5,"key":0}],"data":{}},{"key":"9q4nr","text":"","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}}],"entityMap":{"0":{"type":"Video","mutability":"IMMUTABLE","data":{"src":"www.url.com/video.mp4"}}}};
